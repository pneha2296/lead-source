...
const SOURCE_DOCS = {
  ...
  phoneContact: {
    title: 'Phone Contact',
    description: 'Connect your phone to automatically capture contacts as leads. Create a connection, download our mobile app, scan the QR code, and start syncing contacts instantly.',
    videoUrl: null,
    steps: [
      {
        title: 'Create a Connection',
        description: 'Find the Phone Contact card in Lead Sources and click "Create Connection". Enter a meaningful name for your connection (e.g. "Sales Team Phones", "Field Agent Contacts"). A webhook URL and QR code will be generated automatically.',
        image: '/leadsource/assets/leadsource/phone_connect.png',
      },
      {
        title: 'Download Our Mobile App',
        description: 'Download and install our mobile application on your phone. The app is available for both Android and iOS devices.',
        image: '/leadsource/assets/leadsource/phone_download_app.png',
        tip: 'Make sure to allow the app to access your phone contacts when prompted.',
      },
      {
        title: 'Scan the QR Code',
        description: 'Open the app on your phone and use the built-in QR scanner to scan the QR code shown on the connection card (click Configure to view it). This will automatically configure the app to sync with your account.',
        image: '/leadsource/assets/leadsource/phone_scan_qr.png',
        tip: 'You can also find the QR code by clicking "Configure" on your Phone Contact connection card.',
      },
      {
        title: 'Connection Configured',
        description: 'Once the QR code is scanned, your phone is linked to the connection. Contacts from your phone will now be synced automatically as leads.',
        image: '/leadsource/assets/leadsource/phone_configured.png',
      },
      {
        title: 'Add Webhooks (Optional)',
        description: 'Navigate to Webhooks on your connection card to add outbound webhook URLs. These will receive real-time notifications when new contacts are synced from your phone, allowing you to forward lead data to external systems.',
        image: '/leadsource/assets/leadsource/phone_webhooks.png',
      },
      {
        title: 'View Logs & Monitor',
        description: 'Use the Logs section to monitor all synced contacts. Each log entry shows the source, status, contact data, and sync timestamp. Verify that your contacts are being captured correctly.',
    ...
    features: [
      ...
      'Automatic contact sync from phone',
      'Real-time lead capture',
      'Map phone contact fields to CRM fields',
      'Auto-create CRM contacts on sync',
      'Forward leads to outbound webhooks',
